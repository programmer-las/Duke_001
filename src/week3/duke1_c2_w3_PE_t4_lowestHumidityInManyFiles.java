...
//        FileResource fr = new FileResource();
        FileResource fr = new FileResource("./src/week3/nc_weather/2014/weather-2014-01-20.csv");
        CSVParser parser = fr.getCSVParser();
...
//        System.out.println("Value of parametr " + currentRec.get(parametr));
    ...
    public static void testlowestHumidityInManyFiles() {
        ...
        System.out.println("the lowest humidity AND the time the lowest humidity occurred\n" +
        ...
        for (File f: dr.selectedFiles()) {
            ...
            for (CSVRecord currentRec : parser) {
                if (oldRec == null) {
                    ...
                    lowerSoFarRecord = minTwoRecords(currentRec, oldRec, "Humidity");
//                    lowerSoFarRecord = lowestHumidityInFile();
                }
            }
        }
        return lowerSoFarRecord;
    }
    public static CSVRecord averageTemperatureInFile(CSVParser parser) {
    }
}