...
public class duke1_c2_w4_PE_T6_getAverageRank {
...
//            System.out.println("");
    ...
    public static void testgetAverageRank() {
        String name = "Mason";
        String year = "M";
        System.out.println("The Average Rank of name " + name + " was " + getAverageRank(name,year));
    }
...
//        int rankHighestSoFar = 1000000;
        ...
        double average = rankSum/(double)count;
        return average;
    }
}